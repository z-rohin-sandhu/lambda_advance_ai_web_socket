...
class EnvConfig:
    ...
    REDIS_CONNECTION_TTL_SECONDS = int(
        os.environ.get("REDIS_CONNECTION_TTL_SECONDS", DEFAULT_CONNECTION_TTL_SECONDS)
    )
    REDIS_SESSION_TTL_SECONDS_SECONDS = int(
        os.environ.get("REDIS_SESSION_TTL_SECONDS", DEFAULT_SESSION_TTL_SECONDS_SECONDS)
    )
